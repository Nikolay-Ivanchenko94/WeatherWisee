...
public class FutureAdapter extends RecyclerView.Adapter<FutureAdapter.viewHoder> {
    ...
    @NonNull
    @Override
    public FutureAdapter.viewHoder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull FutureAdapter.viewHoder holder, int position) {
        ...
        Glide.with(context)
                ...
                .into(holder.ImageViewPicFuture);
